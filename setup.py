...
plugin_identifier = "gcodescriptmanager"

# The plugin's python package, should be "octoprint_<plugin identifier>", has to be unique
plugin_package = "octoprint_gcodescriptmanager"

# The plugin's human readable name. Can be overwritten within OctoPrint's internal data via __plugin_name__ in the
# plugin module
plugin_name = "OctoPrint-GcodeScriptManager"
...
# module
plugin_description = """Easily manage multiple GCODE scripts."""
...
plugin_url = "https://github.com/kforth/OctoPrint-GcodeScriptManager"
